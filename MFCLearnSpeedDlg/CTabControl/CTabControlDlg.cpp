...
{
	CDialogEx::DoDataExchange(pDX);
	DDX_Control(pDX, IDC_TABCONTROLDLG, m_tab);
}
...
BEGIN_MESSAGE_MAP(CCTabControlDlg, CDialogEx)
	...
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_NOTIFY(TCN_SELCHANGE, IDC_TABCONTROLDLG, &CCTabControlDlg::OnTcnSelchangeTabcontroldlg)
END_MESSAGE_MAP()


// CCTabControlDlg 消息处理程序
...
void CCTabControlDlg::OnTcnSelchangeTabcontroldlg(NMHDR *pNMHDR, LRESULT *pResult)
{
	// TODO: 在此添加控件通知处理程序代码
	*pResult = 0;
}
